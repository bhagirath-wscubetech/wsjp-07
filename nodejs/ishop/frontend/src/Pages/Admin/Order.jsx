...
const TableRow = ({ order, index }) => {
    ...
    return (
        <tr key={index} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
            ...
            <td>
                <select onChange={(e) => changeOrderStatus(e.target.value)} value={order_status} name="" id="" className='p-2 border focus:outline-none'>
                    <option value="1">Payment pending</option>
                    <option disabled value="2">Payment Done</option>
