...
const View = () => {
    ...
    const [colors, setColor] = useState([]); // state init
                                    ...
                                    return (
                                        <tr key={color._id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                            ...
                                            <td className="px-6 py-4 flex gap-3 items-center">
                                                <MdDeleteOutline onClick={() => del(color._id)} className='text-2xl cursor-pointer text-red-500' />
